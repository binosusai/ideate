# Research Brief: Micro SaaS landing page roast agent

## Raw Intent
Founders paste a landing page URL or copy, agents critique positioning, pricing, objections, and conversion leaks, then generate a prioritized rewrite plan.

## Track
This idea is on the `money` track, so the primary research lens is commercial opportunity.

## Working Hypothesis
Micro SaaS landing page roast agent is worth exploring if it can produce a visible result within one week and a useful proof of concept within one focused session.
