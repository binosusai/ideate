# POC Report: Medium article writer in my style

## Result
A complete local proof of concept was generated outside the Ideate folder.

## Location
`/Users/siddharthshankar/workspace/codex/pocs/mediumarticlewriterinmystyle`

## How To Run
```bash
cd /Users/siddharthshankar/workspace/codex/pocs/mediumarticlewriterinmystyle
